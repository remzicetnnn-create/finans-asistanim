...
# --- ANLIK SESLİ SOHBET MOTORU (KESİN ÇALIŞAN MODEL) ---
...
if ses_verisi is not None:
    ...
    with str_app.spinner("Yapay Zeka Yanıtlıyor..."):
        # Model adını ücretsiz katmanda her zaman çalışan resmi sürümle güncelledik
...
# --- ANLIK YAZILI SOHBET MOTORU (KESİN ÇALIŞAN MODEL) ---
